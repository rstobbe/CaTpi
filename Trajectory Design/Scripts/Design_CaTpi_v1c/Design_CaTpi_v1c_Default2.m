...
function [default] = Design_CaTpi_v1c_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    desmethpath = [SCRPTPATHS.pioneerloc,'Trajectory Design\Underlying\Selectable Functions\DesMeth Functions\'];      
elseif strcmp(filesep,'/')
end
desmethfunc = 'DesMeth_TpiSmoothOptions_v1b';
