%==================================================
% (v1f)
%    - Change cone distribution for pancake voxels
%==================================================

function [SCRPTipt,DESMETH,err] = DesMeth_CaTpi_v1f(SCRPTipt,DESMETHipt)
...
% Projection Sampling
%---------------------------------------------
PSMP.method = 'ProjSamp_ElipSelectOsamp_v1a';
