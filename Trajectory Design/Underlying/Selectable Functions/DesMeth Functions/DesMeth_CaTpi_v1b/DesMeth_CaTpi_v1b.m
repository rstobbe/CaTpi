%==================================================
% (v1b)
%    - Include testing capability to make all trajectories straight
%==================================================

function [SCRPTipt,DESMETH,err] = DesMeth_CaTpi_v1b(SCRPTipt,DESMETHipt)
...
% Projection Sampling
%---------------------------------------------
PSMP.method = 'ProjSamp_Cones_v1h';
PSMP.PCDfunc = 'ProjConeDist_TPI1c_v1j';
