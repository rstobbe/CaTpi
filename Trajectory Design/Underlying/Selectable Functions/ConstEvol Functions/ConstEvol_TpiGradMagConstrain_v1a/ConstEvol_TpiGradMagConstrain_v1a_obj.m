...
classdef ConstEvol_TpiGradMagConstrain_v1a_obj < handle
...
% Constructor
%---------------------------------------------
function obj = ConstEvol_TpiGradMagConstrain_v1a_obj(kArr,tArr,GradSlewMax,GradAccMax,PROJdgn,PROJimp,TST)
    obj.kArr = kArr;
    obj.tArr = tArr;
...
function bool = TestGreaterSpecifyVel(obj,Vel)
    bool = 0;
    if CurVel(obj) > Vel
        bool = 1;
    end
