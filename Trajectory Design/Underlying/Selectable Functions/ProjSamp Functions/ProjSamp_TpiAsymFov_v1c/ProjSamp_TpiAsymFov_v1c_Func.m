...
function [PSMP,err] = ProjSamp_TpiAsymFov_v1c_Func(PSMP,INPUT)
...
for n = 1:length(PCD.conephi)
    plot([0 sin(PCD.conephi(n))*PROJdgn.rad],[0 cos(PCD.conephi(n))*PROJdgn.rad*PROJdgn.elip],'k');
end
axis equal;
%---
