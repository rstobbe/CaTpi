...
function [PSMP,err] = ProjSamp_ElipSelectOsamp_v1a_Func(PSMP,INPUT)
...
%---------------------------------------------
PSMP.PCDfunc = 'ProjConeDist_TPI1f_v1j';
...
if PROJdgn.elip > 1
    % INPUT.PhiThetaFrac = 0;
    INPUT.PhiThetaFrac = 0.35;
else
    INPUT.PhiThetaFrac = 1;
end
INPUT.eproj = eproj;
INPUT.TST = TST;
