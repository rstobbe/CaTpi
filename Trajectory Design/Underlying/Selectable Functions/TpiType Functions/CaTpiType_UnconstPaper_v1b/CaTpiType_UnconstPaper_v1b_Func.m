...
function [TPIT,err] = CaTpiType_UnconstPaper_v1b_Func(TPIT,INPUT)

err.flag = 0;
err.msg = '';

TPIT.tpiin = @TpiSampDensDesign2_v1a;
TPIT.tpiout = @TpiSampDensDesign2_v1a;
...
% SampDensTPI
%====================================================
function dy = TpiSampDensDesign2_v1a(t,y,phi,INPUT)  
