...
function [TPIT,err] = CaTpiType_RetroTpi_v1a_Func(TPIT,INPUT)

err.flag = 0;
err.msg = '';

TPIT.tpiin = @TwistEvo;
TPIT.tpiout = @TwistEvo;
TPIT.radevin = @RadEvo;
TPIT.radevout = @RadEvo;
...
% TwistEvo
%====================================================
function dy = TwistEvo(t,y,phi,INPUT)  
...
dtheta = sqrt((1-dr^2)/(r^2*sin(phi)^2));
dy = [dr;dtheta];

%====================================================
% RadEvo
%====================================================
function dr = RadEvo(t,r,INPUT)  
