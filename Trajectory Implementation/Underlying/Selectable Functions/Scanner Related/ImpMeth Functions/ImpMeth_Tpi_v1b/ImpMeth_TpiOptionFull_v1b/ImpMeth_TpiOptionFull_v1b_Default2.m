...
function [default] = ImpMeth_TpiOptionFull_v1b_Default2(SCRPTPATHS)
...
DEsoltimfunc = 'DeSolTim_TpiManual_v1e';
accconstfunc = 'ConstEvol_TpiCentreAccelerate_v1j';
TrajSampfunc = 'TrajSamp_SiemensStandard_v3i';
ProjSampfunc = 'ProjSamp_Cones_v1f';
TrajEndfunc = 'TrajEnd_StandardSpoil_v1d';
