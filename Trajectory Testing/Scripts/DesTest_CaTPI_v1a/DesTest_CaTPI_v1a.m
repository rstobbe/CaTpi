...
function [SCRPTipt,SCRPTGBL,err] = DesTest_CaTPI_v1a(SCRPTipt,SCRPTGBL)
...
global FIGOBJS
FIGOBJS.(SCRPTGBL.RWSUI.tab).Info.String = TST.ExpDisp;
...
name = inputdlg('Name Test:','Name Test',[1 80],{['Test',TST.name,'_',name0]},'On');
name = cell2mat(name);
if isempty(name)
